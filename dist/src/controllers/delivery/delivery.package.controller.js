...
exports.deleteDeliveryPackage = exports.updateDeliveryPackage = exports.getDeliveryPackageById = exports.getAllDeliveryPackages = exports.createDeliveryPackage = void 0;
...
exports.createDeliveryPackage = (0, asyncHandler_1.default)(async (req, res) => {
    try {
        ...
        const createdDeliveryPackage = await deliveryPackageModel.createDeliveryPackage(newDeliveryPackage);
