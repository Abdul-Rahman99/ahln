...
router.post('/new', verifyToken_1.default, (0, authorize_1.authorize)(['create_box']), address_validation_1.createAddressValidation, address_controller_1.createAddress);
