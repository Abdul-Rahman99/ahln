...
router.put('/update/:id', verifyToken_1.default, (0, authorize_1.authorize)(['update_user']), auth_controller_1.uploadUserImage, user_validation_1.updateUserValidator, users_controller_1.updateUser);
